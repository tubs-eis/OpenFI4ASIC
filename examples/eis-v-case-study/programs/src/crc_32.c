/* Based on MiBench telecommunications benchmark */
...
DWORD crc32buf(unsigned char *buf, int len)
{
...
{
    /* 64-byte test data */
    static unsigned char test_data[64] = {
        0x54, 0x68, 0x65, 0x20, 0x71, 0x75, 0x69, 0x63,
        0x6b, 0x20, 0x62, 0x72, 0x6f, 0x77, 0x6e, 0x20,
        0x66, 0x6f, 0x78, 0x20, 0x6a, 0x75, 0x6d, 0x70,
        0x73, 0x20, 0x6f, 0x76, 0x65, 0x72, 0x20, 0x74,
        0x68, 0x65, 0x20, 0x6c, 0x61, 0x7a, 0x79, 0x20,
        0x64, 0x6f, 0x67, 0x2e, 0x20, 0x31, 0x32, 0x33,
        0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x21,
        0x40, 0x23, 0x24, 0x25, 0x5e, 0x26, 0x2a, 0x28
    };

    asm volatile ("" : : "r,m"(test_data) : "memory");
    
    DWORD crc = crc32buf(test_data, 64);

    /* Save CRC result to memory address 0xE00 */
    *((volatile DWORD*)0xE00) = crc;
